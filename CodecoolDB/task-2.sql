...
(1, 1, 4, 'Phoebe', '"Nice job"', true);
INSERT INTO review VALUES
(2, 2, 5, 'Joey', '"Its a tragedy"', true);
INSERT INTO review VALUES
(3, 3, 4, 'Rachel', '"Smelly cat"', true);
INSERT INTO review VALUES
(4, 4, 3, 'Monica', '"Not bad"', true);
INSERT INTO review VALUES
(5, 5, 5, 'Ross', '"Great"', true);
INSERT INTO review VALUES
(6, 6, 4, 'Chandler', '"I am better"', true);
INSERT INTO review VALUES
(7, 7, 3, 'Raj', '"Love u Penny"', true);
INSERT INTO review VALUES
(8, 8, 5, 'Penny', '"Mimóza"', true);
INSERT INTO review VALUES
(9, 9, 4, 'Sheldon', '"Package of comments sent by mail"', true);
INSERT INTO review VALUES
(10, 10, 5, 'Howard', '"OK"', true);


INSERT INTO projects VALUES
(1, 'Cooking', 'English Trifle á la Rachel', 'Tutorial', true, 1);
INSERT INTO projects VALUES
(2, 'Shopping', 'Discount at Ralf Lauren', 'Excersice', false, 2);
INSERT INTO projects VALUES
(3, 'Analisys', 'Who is the bunny?', 'Tutorial', true, 3);
INSERT INTO projects VALUES
(4, 'Baking', 'Choco cookie á la Phoebe', 'Excercise', true, 1);
INSERT INTO projects VALUES
(5, 'Wedding dress', 'Catch a wedding dress to Monica', 'Excercise', true, 2);
INSERT INTO projects VALUES
(6, 'Analisys 2', 'Statitics of weddings in Friends', 'Excercise', false, 3);
...
ALTER TABLE students
ADD CONSTRAINT FK_students_review FOREIGN KEY (student_id) REFERENCES review(review_id);

ALTER TABLE students
ADD CONSTRAINT FK_students_projects FOREIGN KEY (course_id) REFERENCES projects(id);
